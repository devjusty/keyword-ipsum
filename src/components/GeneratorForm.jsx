  ...
  return (
    ...
    >
      ...
      <div className="generator-form__keywords flex flex-col sm:flex-row gap-4">
        ...
        <div className="generator-form__synonyms flex flex-col items-center">
          <label
      ...
      {/* Controls Row */}
      <div className="generator-form__generation-controls flex flex-col sm:flex-row gap-4 items-end">
        {/* Length Input */}
      ...
      {/* Options Row */}
      <div className="generator-form__options flex flex-col sm:flex-row gap-4 items-end">
      ...
      <div className="pt-2">
        <button
          type="submit"
          className="btn btn-primary w-full md:w-auto md:mx-auto min-w-[200px] whitespace-nowrap"
        >
          Generate Ipsum
        </button>
      </div>
